...
parser.add_argument("--dataset_dir", type=str, default='/media/haiyutan/Data Analytics/Dataset_256_gen')
parser.add_argument("--distortion_type", type=list, default=['barrel','pincushion'])
